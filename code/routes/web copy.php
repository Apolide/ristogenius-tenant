...
Route::domain(env('DOMAIN'))->group(function () {
    ...
    //     return redirect('/manage/contants');
    // })->name('dashboard');
    ...
    // #Tenants
    // Route::get('/manage/contants', TenantIndex::class);
    ...
    Route::group(['middleware' => ['auth:sanctum', 'role:admin']], function () {
        ...
        // Route::get('/dashboard/{tenant?}', function ($contact = null) {
        //     if ($contact) {
        //         $contactModel = App\Models\Tenant::findOrFail($contact);
        //         $fundsService = app(App\Services\Funds\TenantFundsService::class);
        //         $funds = $fundsService->getTenantFunds($contact);
        //         $stats = $fundsService->getFundStats($contact);
