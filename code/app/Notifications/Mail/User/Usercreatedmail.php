...
class Usercreatedmail extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage->subject(__($this->payload['tenant_name']." - Utente Registrato"));
        $mailMessage->greeting(__("Ciao :display_name", ["display_name" => $this->payload['display_name']]));
        $mailMessage->line("Il tuo account su ".$this->payload['tenant_name']." è stato creato.");
        ...
        $mailMessage->action(__('Imposta password'), "https://".$this->payload['tenant_system_name'].".ristopilot.com".$this->payload['url']);
