  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        bootstrapcardborder:"rgb(var(--bootstrap-card-border))",
      ...
      // },
      boxShadow: {
        defaultshadow:"-8px 12px 18px 0 #dadee8",
        pageshadow: "0 0 1rem rgba(0,0,0,0.1)",
        darkpageshadow: "0 0 1rem rgba(255,255,255,0.1)"
      },
      backgroundImage: {
        instagram:
    ...
    animation: {
      ...
      loadingtext:"loading 2s infinite",
      wase:"wase 5s linear infinite",
