<ul class="main-menu">
    ...
    <li class="slide__category"><span class="category-name">Controllo</span></li>
    <!-- End::slide__category -->
    ...
    <li class="slide">
        <a href="/manage/tenants" class="side-menu__item">
    ...
    <li class="slide">
        <a href="/manage/suppliers" class="side-menu__item">
            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            <span class="side-menu__label">Fornitori</span>
        </a>
    </li>

    <li class="slide__category"><span class="category-name">Marketing</span></li>
    <li class="slide">
        <a href="/funnels" class="side-menu__item">
            ...
            <span class="side-menu__label">Funnels</span>
        </a>
    </li>

    <li class="slide">
        <a href="/emails" class="side-menu__item">
              <i class="las la-envelope side-menu__icon"></i>
            <span class="side-menu__label mt-1">Emails</span>
        </a>
    </li>
    <li class="slide">
    ...
    <li class="slide">
        <a href="/whatsapp/conversations" class="side-menu__item">
            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            <span class="side-menu__label">Whatsapp Conversations</span>
        </a>
    </li>
    ...
    <li class="slide has-sub">
        ...
        <ul class="slide-menu child1">
            ...
            <li class="slide">
                <a href="/settings/openinghours" class="side-menu__item">Orari di apertura</a>
            </li>
            <li class="slide has-sub">
                ...
                <ul class="slide-menu child3">
                    <li class="slide">
                        <a href="/settings/rooms" class="side-menu__item">Sala</a>
                    </li>
                    <li class="slide">
                        <a href="/settings/tables" class="side-menu__item">Tavoli</a>
                    </li>
                </ul>
            </li>
