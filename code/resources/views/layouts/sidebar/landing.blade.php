        ...
        <div class="main-sidebar">
            <nav class="main-menu-container nav nav-pills flex-column sub-open">
                ...
                <ul class="main-menu">
                    ...
                    <li class="slide">
                        <a href="/caratteristiche" class="side-menu__item">
                            <span class="side-menu__label">Caratteristiche</span>
                        </a>
                    </li>
                    <li class="slide has-sub open">
                        <a href="javascript:void(0);" class="side-menu__item">
                            <span class="side-menu__label me-2">Video</span>
                    ...
                    <li class="slide">
                        <a href="/customer/login" class="side-menu__item">
                            <span class="side-menu__label">Area utenti</span>
                        </a>
                    </li>
                </ul>
