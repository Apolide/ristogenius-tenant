    ...
    <div class="md:flex block items-center justify-between mb-6 page-header-breadcrumb">
        <div class="my-auto">
            ...
            <nav><ol class="flex items-center whitespace-nowrap min-w-0">
                ...
                <li class="text-[12px] text-textmuted">{{ __('personnel.add') }}</li>
            </ol></nav>
        </div>
        <a href="{{ route('personnel.create') }}" class="ti-btn ti-btn-warning-full text-white ti-btn-icon"><i class="las text-3xl la-redo-alt"></i></a>
    </div>

<div class="box">
    <div class="box-header border-none">
        <div class="box-title pb-0">{{ __('personnel.new_user') }}</div>
    </div>
        ...
        <form wire:submit.prevent="submit">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div class="w-full mb-3">
                    ...
                    <input required wire:model="name" type="text" id="name" class="form-control" placeholder="Nome e cognome">
                ...
                <div class="w-full mb-3">
                    ...
                    <input required wire:model="email" type="email" id="email" class="form-control" placeholder="nome@esempio.it">
                ...
                <div class="w-full mb-3">
                    ...
                    <input required wire:model="phone" type="tel" id="phone" class="form-control" placeholder="+393401234567">
            ...
            <button wire:target="submit" wire:loading.attr="disabled" type="submit" class="ti-btn ti-btn-primary-full ti-btn-wave me-[0.375rem]">
                <span wire:loading.remove wire:target="submit">{{ __('personnel.save_invite') }}</span>
                <span wire:loading wire:target="submit">{{ __('personnel.sending') }}</span>
            </button>
        </form>
    </div>
</div>
