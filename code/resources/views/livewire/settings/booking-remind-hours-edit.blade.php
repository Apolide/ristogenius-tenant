<div class="content">
    <div class="main-content">
        <div class="flex items-center justify-between mb-6 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Promemoria prenotazione</h5>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <form wire:submit.prevent="save" class="space-y-5">
                    <div>
                        <label for="reservation_reminder_hours" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quante ore prima ricordare al cliente della prenotazione?</label>
