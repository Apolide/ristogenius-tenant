<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    <div class="w-full mb-5">
        <label for="firstname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome</label>
        <input wire:model="firstname" type="text" name="firstname" id="firstname" class="form-control" placeholder="Nome">
        @error('firstname') <div class="text-danger text-xs mt-1">{{ $message }}</div> @enderror
    </div>

    <div class="w-full mb-5">
        <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cognome</label>
        <input wire:model="lastname" type="text" name="lastname" id="lastname" class="form-control" placeholder="Cognome">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    <div class="w-full mb-5">
        ...
        <input wire:model="email" type="email" name="email" id="email" class="form-control" placeholder="Email">
    ...
    <div class="w-full mb-5">
        ...
        <input required wire:model="phone" type="tel" name="phone" id="phone" class="form-control" placeholder="Telefono">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    <div class="w-full mb-5">
        ...
        <input wire:model="telegramid" type="text" name="telegramid" id="telegramid" class="form-control" placeholder="Telegram ID">
        @error('telegramid') <div class="text-danger text-xs mt-1">{{ $message }}</div> @enderror
    </div>

    <div class="w-full mb-5">
        <label for="birthdate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data di nascita</label>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5">
    <div class="w-full mb-5">
        <label for="region_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Regione</label>
    ...
    <div class="w-full mb-5">
        <label for="province_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Provincia</label>
    ...
    <div class="w-full mb-5">
        <label for="comuni_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Comune</label>
...
<div class="w-full mb-5">
    ...
    <label for="checkbox-consent-marketing" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3 dark:text-white/70 cursor-pointer">Autorizzazione marketing</label>
</div>
