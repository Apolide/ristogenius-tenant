        ...
        <div class="main-content">
            ...
            <div class="md:flex block items-center justify-between mb-6 mt-[2rem]  page-header-breadcrumb">
              ...
              <div class="flex xl:my-auto right-content align-items-center">
                ...
                <div class="pe-1 xl:mb-0">
                  <a href="/settings/contacts" class="ti-btn ti-btn-warning-full text-white  ti-btn-icon me-2 !mb-0">
                                ...
                                <td class="whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        */ ?>
                                        ...
                                        <div class="hs-tooltip ti-main-tooltip">
                                            <button wire:click="$dispatch('click-edit-contact', { id: '{{ $contact->id }}' })" class="ti-btn ti-btn-sm hs-tooltip-toggle inline-flex items-center gap-x-2 text-sm font-semibold rounded-sm bg-warning text-white hover:bg-warning">
                                        ...
                                        <div class="hs-tooltip ti-main-tooltip">
                                            <button wire:click="$dispatch('click-delete-contact', { id: '{{ $contact->id }}' })" class="ti-btn ti-btn-sm hs-tooltip-toggle inline-flex items-center gap-x-2 text-sm font-semibold rounded-sm bg-danger text-white hover:bg-danger">
